...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Sarah J.",
          handle: "@sarah_marketer",
          testimonial: "Adscookies increased my conversions by 40% in just two months.",
          rating: 5,
        ...
        },
        {
          name: "Mark D.",
          handle: "@mark_shopify",
          testimonial: "The best tracking tool for Shopify. Truly global and reliable.",
          rating: 5,
        ...
        },
        {
          name: "Lisa T.",
          handle: "@lisa_sales",
          testimonial: "Seamless integration, excellent support, and highest commissions.",
          rating: 5,
        ...
        },
        {
          name: "Tom B.",
          handle: "@tom_sales",
          testimonial: "Scaling my store has never been this easy with Adscookies.",
          rating: 5,
        ...
        },
        {
          name: "Anna P.",
          handle: "@anna_shop",
          testimonial: "Reliable data and high-quality affiliate insights.",
          rating: 5,
      ...
      buttons={[
        {
          text: "Claim Your Affiliate Deal",
          href: "#",
        },
      ]}
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/smiling-man-wearing-white-shirt_23-2152009541.jpg",
          alt: "Sarah J.",
        },
        {
        ...
        {
          src: "http://img.b2bpic.net/free-photo/caucasian-man-blazer-sitting-desk-office-with-laptop-looking-camera_1098-20318.jpg",
          alt: "Tom B.",
        },
        {
  ...
  <div id="features" data-section="features">
      ...
      accordionItems={[
        {
          id: "1",
          title: "Global AI Tracking",
          content: "Real-time insights powered by AI for accurate conversion monitoring across 10+ countries.",
        },
        {
          id: "2",
          title: "SEO Friendly Tools",
          content: "Built-in audit tools to ensure your affiliate links maximize your search visibility.",
        },
        {
          id: "3",
          title: "Multi-Platform Support",
          content: "Fully optimized for iOS, Android, Windows, and Linux environments.",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Sign up for a free account, connect your shopify store, and start sharing your unique affiliate links.",
        },
        {
          id: "2",
          title: "Is it global?",
          content: "Yes, we support multi-country operations including US, UK, DE, FR, and many more.",
        },
        {
          id: "3",
          title: "Can I use AI tracking?",
          content: "Our AI tracking comes built-in with every pro and enterprise plan to ensure accuracy.",
        },
      ]}
